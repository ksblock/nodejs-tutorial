...
app.get('/naver/news', (req, res) => {
    const client_id = 'N8Rzom5NbNwrYWIgPuGd';
    const client_secret = 'Xyup00Pu1o';
    const api_url = 'https://openapi.naver.com/v1/search/news?query=' + encodeURI('코스피');//encodeURL(req.query.query)
    const option = {
    };
    const options = {
        url: api_url,
